...
const Certifications = ({ certificationsData }) => {
	...
	const handleClick = ()=>{
		if (isCertificationForm === true) {setIsCertificationForm(false);}
		if (isCertificationForm === false) {setIsCertificationForm(true);}
	...
	return (
		<div className="cert-box">
			...
			<button className='edit-button' onClick={handleClick}>{isCertificationForm ? "x" : "Edit"}</button>
